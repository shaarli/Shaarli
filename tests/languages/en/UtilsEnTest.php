...
class UtilsEnTest extends UtilsTest
{
    ...
    public function testDateFormat()
    {
        ...
        $this->assertRegExp('/January\s2,\s2017\s(at\s)?8:11:12\sPM GMT\+0?3(:00)?/', format_date($date, true, true));
    ...
    public function testDateFormatNoTime()
    {
        ...
        autoLocale('en_US.UTF-8');
        $date = DateTime::createFromFormat('Ymd_His', '20170102_201112');
        $this->assertRegExp('/January\s2,\s2017/', format_date($date, false, true));
        setlocale(LC_ALL, $current);
    }
    ...
    public function testDateFormatDefault()
    {
        ...
        $this->assertEquals('January\s2,\s2017\s10:11:12\sAM\sGMT+03:00', format_date($date, true, false));
    }
    ...
    public function testDateFormatDefaultNoTime()
    {
        ...
        $this->assertEquals('February\s1,\s2017', format_date($date, false, false));
    }
